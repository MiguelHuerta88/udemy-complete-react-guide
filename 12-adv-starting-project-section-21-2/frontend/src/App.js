...
import EventsLayout from "./pages/layouts/Event";
        ...
        children: [
          {
            element: <EventsPage />,
            index: true,
            // loader will run this function before component is loaded up. Usually we keep loader functions in the component/page that uses them and export
            loader: loader,
          },
          {
            path: ":eventId",
